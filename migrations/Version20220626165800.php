 ...
 */
final class Version20220626165800 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lvc ADD CONSTRAINT FK_135205C4FB5230B FOREIGN KEY (tracker_id) REFERENCES cac (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
